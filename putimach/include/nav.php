...
<!--    <div class="container">-->
<!--        <a class="navbar-brand" href="#"><img src="images/putimach logo.png" alt="" style="height: 50px; width: 150px;"></a>-->
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active text-white" aria-current="page" href="chatok/chat12.php">My Circle</a>
                </li>
                <li class="nav-item">
